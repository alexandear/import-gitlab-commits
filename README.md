...
- `EXTRA_AUTHOR_EMAILS` - comma-separated list of additional emails to match commits and project contributors against, besides the ones confirmed on the GitLab account (optional).
